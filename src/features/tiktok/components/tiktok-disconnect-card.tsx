...
import { useTiktokDisconnect } from "@/features/tiktok/hooks/useTiktokDisconnect";

interface TiktokDisconnectCardProps {
  connections: UserConnection[];
}

export function TiktokDisconnectCard({ connections }: TiktokDisconnectCardProps) {
  const t = useTranslations("tiktok.page.disconnect");
  const { mutate: disconnect, isPending } = useTiktokDisconnect();
